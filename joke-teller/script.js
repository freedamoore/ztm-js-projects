...
function tellMe(joke){
    VoiceRSS.speech({
        key: '3415863081684e73b99eec81e562ea8e',
        src: `${joke}`,
        hl: 'en-ie',
        v: 'Oran',
        r: 2, 
...
async function getJokes(){
    ...
    try {
        ...
        //there are one part jokes and two part jokes
        //one part jokes will be under joke
        //two part jokes will be under setup and delivery
        if (data.setup){
